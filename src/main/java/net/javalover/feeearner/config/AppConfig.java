...
public record AppConfig(Map<String, String> params)
{
    ...
    {
        return require("log_dir");
    }

    public String outputDir()
    {
        return require("output_dir");
    }

    public String debugLevel()
    {
        return get("debug_level", "INFO");
    }

    public int threadPoolSize()
    {
        return getInt("thread_pool_size", 2);
    }

    public int maxThreadPoolSize()
    {
        return getInt("max_thread_pool_size", 4);
    }

    public String emailRecipients()
    {
        return get("email_recipients", "");
    }

    public String emailSender()
    {
        return require("email_sender");
    }

    public String emailSubject()
    {
        return require("email_subject");
    }

    public String emailBody()
    {
        return require("email_body");
    }

    public String smtpServer()
    {
        return require("smtp_server");
    }
